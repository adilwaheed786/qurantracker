...
const App: React.FC = () => {
  ...
  const getDailyReflection = useCallback(async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Provide a short, 2-sentence inspirational spiritual reflection from the Holy Quran to encourage someone who is reading Juz ${progress.lastReadJuz}. Make it warm and encouraging. Respond in Urdu with English translation. Use clear Arabic terms like 'Quran' and 'Allah'.`,
      });
  ...
  return (
    <Layout darkMode={darkMode} toggleDarkMode={toggleDarkMode}>
      <section className="mb-8 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        {/* Welcome & Reflection Card */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-emerald-50 dark:border-slate-800 shadow-sm relative overflow-hidden transition-colors">
        ...
        {lastJuz && (
          <div className="bg-emerald-900 dark:bg-emerald-950 rounded-3xl p-6 text-white shadow-2xl shadow-emerald-900/20 dark:shadow-black/40 relative overflow-hidden group transition-colors text-right">
             ...
             <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-amber-400 text-emerald-950 py-4 rounded-2xl font-black hover:bg-amber-300 transition-all shadow-xl active:scale-95 duration-75 text-sm uppercase tracking-wider"
                >
                  اگلا نشان لگائیں
                </button>
             </div>
